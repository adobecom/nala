...
Then(
    ...
    shouldSeeAtLeastOneElementWithAttributes
);

Then(
    /^I should see element with selector "([^\"]*)"$/,
    shouldSeeElementWithSelector
);
...
export function iFocusAndClickTheElement(selector) {
