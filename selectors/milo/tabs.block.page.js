export default class Tabs {
  constructor(page, nth = 0) {
    ...
    this.tab9 = this.tabListContainer.locator(
      'button[role="tab"]:nth-child(9)',
    );
    // tabs panel and content
    this.tabContent = this.tab.locator('.tab-content > .tab-content-container');
    this.tab1Panel = this.tabContent.locator(
      'div[role="tabpanel"]:nth-child(1)',
    );
    this.tab2Panel = this.tabContent.locator(
      'div[role="tabpanel"]:nth-child(2)',
    );
    this.tab3Panel = this.tabContent.locator(
      'div[role="tabpanel"]:nth-child(3)',
    );
    this.tab9Panel = this.tabContent.locator(
      'div[role="tabpanel"]:nth-child(9)',
    );
