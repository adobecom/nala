...
test.describe('Milo Marquee Block test suite', () => {
  ...
  test(`${features[0].name},${features[0].tags}`, async ({ page, baseURL }) => {
    ...
    await test.step('step-3: Verify analytics attributes', async () => {
      ...
      await expect(await marquee.outlineButton)
        .toHaveAttribute('daa-ll', await webUtil.getLinkDaall(data.outlineButtonText, 1, data.h2Text));
  ...
  test(`${features[2].name},${features[2].tags}`, async ({ page, baseURL }) => {
    ...
    await test.step('step-2: Verify Marquee (small, light) specs', async () => {
      ...
      await expect(await marquee.backgroundImage).toBeVisible();
      expect(await webUtil.verifyAttributes_(marquee.backgroundImage, marquee.attributes['marquee.small.light'].backgroundImg))
        .toBeTruthy();
    });
  ...
  test(`${features[3].name},${features[3].tags}`, async ({ page, baseURL }) => {
    ...
    await test.step('step-3: Verify analytic attributes', async () => {
      ...
      await expect(await marquee.outlineButtonXL)
        .toHaveAttribute('daa-ll', await webUtil.getLinkDaall(data.outlineButtonText, 1, data.h2Text));
  ...
  test(`${features[4].name},${features[4].tags}`, async ({ page, baseURL }) => {
    ...
    await test.step('step-2: Verify Marquee (large, light) specs', async () => {
      ...
      await expect(await marquee.backgroundImage).toBeVisible();
      expect(await webUtil.verifyAttributes_(marquee.backgroundImage, marquee.attributes['marquee.large.light'].backgroundImg))
        .toBeTruthy();
    });
  ...
  test(`${features[9].name},${features[9].tags}`, async ({ page, baseURL }) => {
    ...
    await test.step('step-2: Verify Marquee (split, one-third, large, light) specs', async () => {
      ...
      await expect(await marquee.mediaImage).toBeVisible();
      expect(await webUtil.verifyAttributes_(marquee.mediaImage, marquee.attributes['marquee.split.one-third-large'].mediaImg))
        .toBeTruthy();
    });
