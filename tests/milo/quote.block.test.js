...
test.describe('Milo Quote block test suite', () => {
  ...
  test(`${features[0].name},${features[0].tags}`, async ({ page, baseURL }) => {
    ...
    // test step-1
    await test.step('Go to Quote feature test page', async () => {
  ...
  test(`${features[2].name},${features[2].tags}`, async ({ page, baseURL }) => {
    ...
    // test step-1
    await test.step('Go to Quote (inline)e block test page', async () => {
  ...
  test(`${features[3].name},${features[3].tags}`, async ({ page, baseURL }) => {
    ...
    await test.step('Verify Quote (borders) block content / specs ', async () => {
      // verify quote (borders) and its content
  ...
  test(`${features[4].name},${features[4].tags}`, async ({ page, baseURL }) => {
    ...
    await test.step('Verify Quote (align-right) block content / specs ', async () => {
      // verify quote (align-right) and its content
  ...
  test(`${features[5].name},${features[5].tags}`, async ({ page, baseURL }) => {
    ...
    await test.step('Verify Quote (xl-spaced) block content / specs ', async () => {
      // verify quote ((xl-spaced)) and its content
