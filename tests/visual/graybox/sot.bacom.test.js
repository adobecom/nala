  ...
  for (const feature of features) {
    ...
    test(`${feature.name},${feature.tags}`, async ({ page }, testInfo) => {
      ...
      for (const key of Object.keys(testdata)) {
        ...
        const betaURL = testdata[key].replace('business.stage', 'test.business-graybox');
