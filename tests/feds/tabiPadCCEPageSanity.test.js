...
import { features } from '../../features/feds/prodSanity/tabiPadTesting/tabiPadCCE.spec.js';
...
test.describe('Test Suite for Creative Cloud Business Enterprise Page Components', () => {
  ...
  features.forEach((props) => {
    test(`${props.name}, ${props.tags}, ${props.country}`, async ({ page, baseURL }) => {
      ...
      await enterprise.validatingCreativityAndDesignElementsiPadTab(props.country);
